 ...
 */
public class InnovationMachineFragment extends Fragment {
    ...
    public InnovationMachineFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mainView = inflater.inflate(R.layout.fragment_innovation_machine, container, false);
    ...
    private void fetchVideoList() {
        ...
        Call<List<JsonObject>> call = services.getInnovationMachineVideoList();
        call.enqueue(new Callback<List<JsonObject>>() {
            ...
            public void onResponse(Call<List<JsonObject>> call, Response<List<JsonObject>> response) {
                if (response.code() == 204) {
                    ...
                    mAdapter = new YouTubeThumbnailAdapter(getContext(), InnovationMachineFragment.this, dataList);
